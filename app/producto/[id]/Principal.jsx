...
export default function Principal({ producto,imagenesURLs }) {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
        <div className="space-y-4">
          <div className="relative aspect-square overflow-hidden rounded-xl bg-gray-100">
            <img
              src={imagenesURLs[imagenSeleccionada] || "/placeholder.svg"}
              alt={producto.titulo}
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <Link
              href={`/tienda/${producto.id_tienda}`}
              className="inline-flex items-center justify-center px-6 py-2.5 rounded-lg border border-gray-300 bg-white text-gray-900 font-medium transition-all duration-200 ease-in-out hover:bg-indigo-500 hover:text-white hover:border-indigo-500 hover:shadow-md"
